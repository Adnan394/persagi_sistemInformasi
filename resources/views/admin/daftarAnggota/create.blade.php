            ...
            <div class="card-body">
                <form action="{{ route('artikel.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="meta-judul" name="meta_judul" required>
                    </div>
                    <div class="mb-3">
                        <label for="#meta-deskripsi" class="form-label">Meta Deskripsi</label>
                        <input type="text" class="form-control" id="meta-deskripsi" name="meta_deskripsi" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="content" rows="3" name="konten"></textarea>
                    </div>
                    <div class="mb-3">
