            ...
            <div class="card-body">
                <form action="{{ route('event.update', $data->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" class="form-control" id="picture" name="gambar" value="{{ $data->gambar }}">
                    </div>
                    <div class="mb-3">
                        <label for="#description" class="form-label">Deskripsi</label>
                        <textarea class="form-control" id="description" rows="3" name="deskripsi">{{ $data->deskripsi }}</textarea>
                    </div>
                    <div class="mb-3">
                        <label for="#date" class="form-label">Tanggal</label>
                        <input type="date" class="form-control" id="date" rows="3" name="tanggal" value="{{ $data->tanggal }}"></input>
                    </div>
                    <div class="mb-3">
